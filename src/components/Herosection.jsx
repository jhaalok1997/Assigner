            ...
            <div className="">
                <div className="relative">
                    ...
                    <div className="absolute bottom-72 pl-8">
                        <p className="font-title text-4xl font-bold text-[#5A156B]">Navigate Your<br/> Academic Journey<br/> <span className="text-[#E52FDE] font-title">With Confidence</span></p>
